...
import { Home, List, PieChart, Users } from "lucide-react";
  ...
  return (
    <nav style={{
      ...
      <Link href="/family" style={{
        ...
        alignItems: "center",
        gap: "0.25rem",
        color: pathname === "/family" ? "var(--accent-primary)" : "var(--text-secondary)",
        textDecoration: "none"
      }}>
        <Users size={24} />
        <span style={{ fontSize: "0.75rem", fontWeight: 500 }}>Family</span>
      </Link>
